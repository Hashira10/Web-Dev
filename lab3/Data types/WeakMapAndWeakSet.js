...
// New messages are added, old ones are removed regularly by that code, and you don’t 
// know the exact moments when it happens.

// Now, which data structure could you use to store information about whether the 
// message “has been read”? The structure must be well-suited to give the answer “was it read?” 
...
let messages2 = [
  ...
  readMessages.add(messages2[0]);
  readMessages.add(messages2[1]);
  ...
  alert("Read message 0: " + readMessages.has(messages2[0])); // true
